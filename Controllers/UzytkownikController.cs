...
namespace Filmy.Controllers
{
    public class UzytkownikController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //               Problem("Entity set 'FilmyContext.Uzytkownik'  is null.");
            var prac = _context.Uzytkownik.Include(p => p.Oceny).ThenInclude(e => e.Film).AsNoTracking();
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var uzytkownik = await _context.Uzytkownik
                // .Include(p => p.Oceny)
                .Include(p => p.Oceny).ThenInclude(e => e.Film)
        ...
        public async Task<IActionResult> Create([Bind("Id,Imie,Nazwisko,Email,Haslo")] Uzytkownik uzytkownik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Imie,Nazwisko,Email,Haslo")] Uzytkownik uzytkownik)
        {
            if (id != uzytkownik.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FilmyContext.Uzytkownik'  is null.");
            }
            var uzytkownik = await _context.Uzytkownik.FindAsync(id);
            if (uzytkownik != null)
            {
